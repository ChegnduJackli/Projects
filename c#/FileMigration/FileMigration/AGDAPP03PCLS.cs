...
namespace FileMigration
{
    class AGDAPP03PCLS : IMigration
    {
        ...
        string AGDAPP03P_Local_Path = Common.Local_Path_AGDAPP03P;

        public void DoMigration()
        {
            //migration ASSB
            common.DoFileMigration(Local_Assb_ccdgConstants, PRD_Assb_ccdgConstants, AGDAPP03P_Local_Path);
            //migration HelpDesk
            common.DoFileMigration(Local_HelpDesk_WebConfig, PRD_HelpDesk_WebConfig, AGDAPP03P_Local_Path);
            ////migration MBS
            common.DoFileMigration(Local_MBS_pubpassword, PRD_MBS_pubpassword, AGDAPP03P_Local_Path);
            common.DoFileMigration(Local_MBS_Admin_pubpassword, PRD_MBS_Admin_pubpassword, AGDAPP03P_Local_Path);
            //migration SRS
            common.DoFileMigration(Local_ReqSys_batch_SrsCommon, PRD_ReqSys_batch_SrsCommon, AGDAPP03P_Local_Path);
            common.DoFileMigration(Local_ReqSys_Script_WebConfig, PRD_ReqSys_Script_WebConfig, AGDAPP03P_Local_Path);
            //migration Vendors
            common.DoFileMigration(Local_Vendors_batch_batchInv, PRD_Vendors_batch_batchInv, AGDAPP03P_Local_Path);
            common.DoFileMigration(Local_Vendors_Script_Webconfig, PRD_Vendors_Script_Webconfig, AGDAPP03P_Local_Path);
        }
    }
}
