...
//description: for create canvas

; (function ($, window, document, undefined) {   //立即执行函数

var methods = {
init: function(){alert("init in methods");},
flop : function(){alert("flop in methods");}
};
...
alert("App");
    ...
    //});
    //为插件的设置提供公开的访问，在外面调用的时候可以设置这些设置值
